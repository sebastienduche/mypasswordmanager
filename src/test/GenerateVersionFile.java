...
public class GenerateVersionFile {
  ...
  public static void main(String[] args) {
    try (FileWriter writer = new FileWriter("./Build/MyPasswordManagerVersion.txt")) {
      System.out.println("Building Build/MyPasswordManagerVersion.txt");
      String checksum = getMD5Checksum("./Build/MyPasswordManager.jar");
